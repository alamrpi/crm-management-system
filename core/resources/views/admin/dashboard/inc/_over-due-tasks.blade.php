    ...
    <div class="card card-animate border border-1 mb-1">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-4 fs-12">
                    <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Over Day</p>
                    <span class="text-danger">{{ $diff = \Carbon\Carbon::today('Asia/Dhaka')->diffInDays(\Carbon\Carbon::createFromFormat('Y-m-d',$task->due_date))+1 }} {{ $diff > 1 ? 'days' : 'day' }}</span>
                </div>
            </div>
            <div class="row mt-n2">
