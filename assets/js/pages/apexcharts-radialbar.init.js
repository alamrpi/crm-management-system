...
var chartRadialbarBasicColors = getChartColorsArray("basic_radialbar"),
    chartRadialbarMultipleColors = (chartRadialbarBasicColors && (options = {
        ...
        plotOptions: {radialBar: {hollow: {size: "40%"}}},
        labels: ["Completed"],
    ...
    chartStorkeRadialbarColors = (chartRadialbarGradientColors && (options = {
        ...
        plotOptions: {
            radialBar: {
                startAngle: -135,
                endAngle: 225,
                hollow: {margin: 0, size: "84%", image: void 0, imageOffsetX: 0, imageOffsetY: 0, position: "front"},
    ...
    plotOptions: {
        radialBar: {
            ...
            track: {
                ...
                strokeWidth: "97%",
                margin: 5,
                dropShadow: {enabled: !0, top: 2, left: 0, color: "#999", opacity: 1, blur: 2}
            },
