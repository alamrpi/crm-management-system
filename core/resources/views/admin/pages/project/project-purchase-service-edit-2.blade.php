    ...
    <div class="modal-content">
        ...
        <form action="{{ route('admin/project/service/next/update', ['id'=> \App\Utility\Helpers::getParamValue('id')]) }}" method="post" enctype="multipart/form-data">
            ...
            <div id="modalPerDayHour">
                <div id="modalhdnPerDayHourFields">
                    <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control form-control-sm @error('total_hour') is-invalid @enderror" id="modaltotal_hour" name="total_hour" readonly required value="{{ $purchaseService->total_hour }}">
                @error('total_hour')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
