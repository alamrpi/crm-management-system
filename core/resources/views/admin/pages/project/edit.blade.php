                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="description">Project Description<span
                                                        class="text-danger">*</span></label>
                                            <textarea class="form-control ck-editor @error('description') is-invalid @enderror"
                                                ...
                                                <div class="mb-3 mb-lg-0">
                                                    ...
                                                    <select class="form-select @error('priority') is-invalid @enderror"
                                                        ...
                                                        @foreach(\App\Constants\Priority::GetPriorities() as $value => $type)
                                                            <option value="{{ $value }}" {{ $project->priority == $value ? 'selected' : ''}}>{{ $type }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('priority')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                ...
                                                <div class="mb-3 mb-lg-0">
                                                    ...
                                                    <select class="form-select @error('status') is-invalid @enderror"
                                                        ...
                                                        @foreach(\App\Constants\ProjectStatus::GetStatuses() as $value => $type)
                                                            <option value="{{ $value }}" {{ $project->status == $value ? 'selected' : ''}}>{{ $type }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('status')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="text-end mb-4">
                                    <button type="submit" class="btn btn-success w-sm">Update & Continue</button>
                                </div>
                            </div>
                        </div>
                    </form>
