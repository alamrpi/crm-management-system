...
<head>
    ...
    <meta charset="utf-8" />
    <title>@yield('title') | Doctor | EMED</title>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="{{ route('doctor/profile') }}"><i class="mdi mdi-account-lock-open-outline text-muted fs-16 align-middle me-1"></i> <span class="align-middle">My Account</span></a>
                            <a class="dropdown-item" href="{{ route('doctor/change-password') }}"><i class="mdi mdi-key text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Change Password</span></a>
    ...
    <div class="app-menu navbar-menu">
        ...
        <div id="scrollbar">
            <div class="container-fluid">
                ...
                @include('doctor.shared.topbar-menu')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="text-sm-end d-none d-sm-block">
                            Develop & Manage By BASIC STARTER
                        </div>
                    </div>
                </div>
            </div>
