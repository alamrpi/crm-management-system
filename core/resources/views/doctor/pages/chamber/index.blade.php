...
@section('title') All Chamber @endsection
                    ...
                    <div class="">
                        <table class="table table-sm table-nowrap mb-0 table-bordered">
                            ...
                            <tr>
                                ...
                                <th scope="col">Mobile/Hotline</th>
                            ...
                            <tr>
                                ...
                                <td>Elahi Homeo Healing Center</td>
                                <td>North Mugda, Dhaka</td>
                                <td>01729018639</td>
                                <td>-</td>
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate3d(0px, 42px, 0px);">
                                            <a class="dropdown-item" href="{{ route('doctor/chamber/visitingTime', ['id'=>1]) }}">Visiting Time</a>
