...
const navLinks = document.querySelectorAll(".nav-item"), menuToggle = document.getElementById("navbarSupportedContent");
var bsCollapse = "";
...
navLinks && menuToggle && (window.addEventListener("load", function () {
    ...
    bsCollapse = new bootstrap.Collapse(menuToggle, {toggle: !1}), e < 980 ? Array.from(navLinks).forEach(e => {
...
function check() {
    var n = document.getElementById("plan-switch"), e = document.getElementsByClassName("month"),
        t = document.getElementsByClassName("annual"), o = 0;
...
function counter() {
    ...
    e && e && Array.from(e).forEach(function (l) {
        !function e() {
            var n = +l.getAttribute("data-target"), t = +l.innerText, o = n / 250;
...
function scrollFunction() {
    if(100 < document.body.scrollTop || 100 < document.documentElement.scrollTop) {
        ...
        $('#top-navbar').addClass('fixed-top border-bottom border-1');
    }
    else {
        mybutton.style.display = "none";
        $('#top-navbar').removeClass('fixed-top border-bottom border-1');
    }
}
