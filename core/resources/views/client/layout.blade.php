...
<div id="layout-wrapper">
        ...
        <div class="layout-width">
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <!-- App Search-->
                    <h3 class="d-flex align-items-center text-uppercase" style="margin-top: 10px; color: #0070ad ;">WITL CRM</h3>
                </div>
    ...
    <!-- ========== App Menu ========== -->
    <div class="app-menu navbar-menu" style="background: #e9f4ff;border-right: 1px solid #b6cfdd;">
        <!-- LOGO -->
        ...
        <div id="scrollbar">
            <div class="container-fluid">
                <x-client.sidebar :projectId="$current_project ? $current_project['id'] : 0 "/>
            </div>
            <!-- Sidebar -->
        </div>
...
<script>
    ...
    $('#switchable-project-list').on('change', function() {
