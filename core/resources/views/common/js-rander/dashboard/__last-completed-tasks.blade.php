                ...
                <div class="row">
                    <div class="col-4">
                        <div class="d-flex align-items-center" style="width: 100px;">
                            <div class="flex-shrink-0 me-1 text-muted fs-10">100%</div>
                        ...
                        <p class="text-muted fs-12">10/10 Tasks | 10/10 Hrs</p>
                    </div>
                    ...
                    <div class="col-4 fs-12">
                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Completed Date</p>
                        {{ date('m/d/Y') }}
                    </div>
                </div>
                <div class="row mt-n2">
